...
import { useSettings, useUI, useLogStore, useTools, getPersonas } from '../lib/state';
import c from 'classnames';
import {
  getAvailableVoicesFull,
  getAvailableVoicesLimited,
  getModelsWithLimitedVoices,
  getDefaultVoice,
} from '../lib/constants';
...
export default function Sidebar() {
  ...
  const availableVoices = useMemo(() => {
    return getModelsWithLimitedVoices().includes(model)
      ? getAvailableVoicesLimited()
      : getAvailableVoicesFull();
  }, [model]);
            ...
            <fieldset disabled={connected}>
              {isEasterEggMode && (
                <label>
                  ...
                  >
                    {Object.keys(getPersonas()).map(personaName => (
