...
class _RouteViewerScreenState extends State<RouteViewerScreen> {
  ...
  void _viewTripDetails() {
    ...
    final trip = Trip(
      ...
      departOrigin: _extractTime(_selectedOutbound!.departTime),
      arriveDestination: _extractTime(_selectedOutbound!.arriveTime),
      ...
      departDestination: _extractTime(_selectedReturn!.departTime),
      arriveOrigin: _extractTime(_selectedReturn!.arriveTime),
